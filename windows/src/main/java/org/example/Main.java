...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        if (params.has("input")) {
            ...
            dataStream = env.fromSource(source, WatermarkStrategy.forMonotonousTimestamps(), "File Source").
                    assignTimestampsAndWatermarks(WatermarkStrategy.<String>forMonotonousTimestamps().withTimestampAssigner((event, timestamp) -> System.currentTimeMillis()));
        } else {
