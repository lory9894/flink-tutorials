...
public class readingAndWriting {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> filteredStream = dataStream.flatMap(new FlatMapper()).filter(Filters.charThreeFilter);
    ...
    public static class FlatMapper implements FlatMapFunction<String, String> {

        public void flatMap(String value, Collector<String> out) throws Exception {
            for(String word: value.split(",")){

                out.collect(word.trim().replace(",", ""));
            }
        }
    }
}